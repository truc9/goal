            ...
            <div className="tw-flex tw-flex-col tw-gap-5">
                <div className="tw-flex tw-flex-col tw-items-center tw-justify-center tw-gap-3">
                    <div className="tw-flex tw-items-center tw-gap-1 tw-px-1 tw-py-1 tw-rounded tw-bg-emerald-50 tw-border-emerald-100 tw-border">
                        <button disabled={index === 0} onClick={goBack} className="disabled:tw-bg-slate-200 tw-p-1 tw-shadow-lg tw-bg-emerald-500 tw-text-white tw-rounded"><FiChevronLeft size="26" /></button>
                        {period ? (
                        ...
                        <button disabled={index === periods.length - 1} onClick={goNext} className="disabled:tw-bg-slate-200 tw-p-1 tw-shadow-lg tw-bg-emerald-500 tw-text-white tw-rounded"><FiChevronRight size="26" /></button>
                    </div>
                </div>
                {period && (
