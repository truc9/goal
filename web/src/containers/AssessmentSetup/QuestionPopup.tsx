      ...
      <Popup
        ...
        <TabContent value={tabIndex} index={0}>
          <div className="tw-flex tw-flex-col tw-gap-3">
            <FormGroup>
              <FormLabel id="question-label" sx={{ fontWeight: 'bold' }}>
                Question
              </FormLabel>
              <TextareaAutosize
            ...
            <FormControl>
              <FormLabel sx={{ fontWeight: 'bold' }} id="question-type-label">
                Question Type
              </FormLabel>
              <RadioGroup
                row
        ...
        <TabContent value={tabIndex} index={1}>
          <Box
            ...
            {isChoiceQuestion && (
              <>
                <button onClick={showChoicePopup} className="btn-secondary">
